        ...
        if (isNumber == true) {
            ...
            if (number > random_numbers) {
                if (difference > 10) {
                    ...
                    cout << endl << "       \033[1;33m# Anda yang ditebak terlalu tinggi! #\033[0m      " << endl;
                ...
                if (difference > 10) {
                    ...
                    cout << endl << "       \033[1;33m# Anda yang ditebak terlalu rendah! #\033[0m      " << endl;
                    cout << "       \033[1;33m-------------------------------------\033[0m      " << endl;
                }
            } else {
